...
[Github Python资源整合](https://github.com/vinta/awesome-python)
...
<span id="python程序可以分解成模块、语句、表达式和对象"></span>
...
<span id="python基础语法"></span>
# python基础语法

---

<span id="在Linux上使用新版本的python"></span>
## 在Linux上使用新版本的python
...
### 2、使用pyenv管理多版本并存，详见[python编程环境准备](00Environment.md)；
